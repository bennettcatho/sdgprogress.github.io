...
def run_and_evaluate(model_func, df, notnulls, WINDOWS, alphas=None):
    results = model_func(df, notnulls, WINDOWS, alphas)
...
models = [
    ...
    (run_ridge_regression, df, notnulls, WINDOWS, 1.0),
    (run_ridge_autotune_regression, df, notnulls, WINDOWS, alphas),
]
