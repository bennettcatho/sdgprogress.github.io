...
print("Fixed alpha. Fixed evaluation function.")
# started at 12h16 (13h26 still running)
# Settings
import warnings
...
try:
    ...
    print("Error running Linear Regression: ", e)
...
try:
    ...
    print("Error running Bayesian Regression: ", e)
...
try:
    ...
    print("Error running Ridge Regression: ", e)
try:
    ...
    ridge_auto_results.to_csv("results/ridge_auto_results.csv", index=False)
except Exception as e:
    print("Error running Ridge Regression with Autotuning: ", e)
...
try:
    ...
    print("Error combining evaluations: ", e)
